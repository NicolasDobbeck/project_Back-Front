...
const getAlunosCurso = (id) => {
    ...
    alunos.forEach(item => {
        item.curso.forEach(i => {
            i.sigla.toLowerCase().includes(cursoAluno.toLowerCase())

            let cursos = {}

            cursos.nomeCurso = i.nome
            cursos.siglaCurso = i.sigla
            cursos.iconeCurso = i.icone
            cursos.cargaCurso = i.carga
            cursos.conclusaoCurso = i.conclusao
